...
//                        }
                ...
                if ($inseriu['resultado'] == 'ok') {
                        ...
                        if ($_POST['Datas'][0]) {
                            $sql = "select * from inscricoes where Email_txf='{$_POST['Email_txf']}' and Namespace_empresa_txf='{$_POST['Namespace_empresa_txf']}' and Namespace_promocao_txf='{$_POST['Namespace_promocao_txf']}'";
