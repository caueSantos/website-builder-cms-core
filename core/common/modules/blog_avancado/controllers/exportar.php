    ...
    function switch_pagina() {
        ...
        switch ($this->pagina_atual) {
            ...
            case 'rss':
                ...
                $posts = $this->mbc->buscar_completo("post", "where Ativo_sel='SIM' order by Data_dat desc $limit");
...
// Criar elemento channel, como filho do elemento rss
                ...
                $channel->addChild('description', 'Feed da Lands');
...
// Adiciona sub-elementos ao elemento <item>
                    ...
                    $item->addChild('link', "{$this->app->Url_cliente}posts/{$id}");
