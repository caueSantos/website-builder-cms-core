...
* License.
*/
require_once (COMMONPATH . 'third_party/hubspot/class.baseclient.php');
...
//&property=firstname&property=lastname&property=email&property=phone&property=mobilephone&property=jobtitle&property=company
