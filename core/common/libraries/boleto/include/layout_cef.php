...
<HTML>
  <HEAD>
    ...
    <base href="http://assets.lands.net.br/boleto/" >
    <style type=text/css>
      <!--.cp {
...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
  <tr>
    ...
    <td class=ti width=455>
      ...
      <?php echo isset($dadosboleto["cpf_cnpj"]) ? "
<br>
    ...
    <tr>
      ...
      <td class=cp valign=top width=134 height=12>
        ...
        <span class="campo">
          ...
          <?php echo ($dadosboleto["data_vencimento"] != "") ? $dadosboleto["data_vencimento"] : "Contra Apresentação" ?>
