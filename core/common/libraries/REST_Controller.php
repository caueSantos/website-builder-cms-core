...
class REST_Controller extends lands_core {
...
//die();
    ...
    protected function _detect_method() {
        ...
        $method = strtolower($this->input->server('REDIRECT_REDIRECT_REQUEST_METHOD'));
        if (!$method) {
