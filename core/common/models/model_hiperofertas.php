...
class Model_hiperofertas extends Model_banco_cliente {
...
//  public $tabela_emails_proprietario = 'contato';
    ...
    function verifica_inscricao_dupla($user = null) {
        ...
        if($_POST['Facebook_id_txf']) {
            ...
            $sql = "select * from {$this->tabela_inscricoes} where Email_txf='{$email}' and Namespace_empresa_txf='{$this->namespace_empresa}' and Namespace_promocao_txf='{$this->namespace_promocao}' ";
        }
