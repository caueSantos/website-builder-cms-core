...
<section class="experimente {if $tipo == 1}text-white{/if} pt-70 pb-80 overflow-hidden">
      ...
      <div class="col-md-6">
        <div class="row justify-content-center align-center">
          ...
          <div class="col-12 col-md-7">
            <input
              type="email" class="form-lands mb-0 {if $pagina_atual == 'cases'}form-outline form-dark{/if}" name="Email_txf"
