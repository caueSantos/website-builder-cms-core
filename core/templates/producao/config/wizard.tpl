		...
		<link href="//assets.lands.srv.br/config/wizard/src/bootstrap-wizard.css" rel="stylesheet" />
		<link href="//assets.lands.srv.br/config/wizard/chosen/chosen.css" rel="stylesheet" />
		<style type="text/css">
			.wizard-modal p {
				margin: 0 0 10px;
				padding: 0;
		...
		<script src="//assets.lands.srv.br/config/wizard/chosen/chosen.jquery.js"></script>
		<script src="//assets.lands.srv.br/config/wizard/js/bootstrap.min.js" type="text/javascript"></script>
		<script src="//assets.lands.srv.br/config/wizard/js/prettify.js" type="text/javascript"></script>
		<script src="//assets.lands.srv.br/config/wizard/src/bootstrap-wizard.js" type="text/javascript"></script>
                
                	<!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
		<!-- WARNING: Respond.js doesn't work if you view the page via file:// -->
		<!--[if lt IE 9]>
		<script src="wizard/js/html5shiv-3.7.0.js"></script>
		<script src="wizard/js/respond-1.3.0.min.js"></script>
		<![endif]-->
		...
		<div class="wizard" id="satellite-wizard" data-title="Criar App">
