<?php /* Smarty version Smarty-3.1.12, created on 2020-12-12 13:52:43
         compiled from "core\templates\producao\hubvet\site\blocos\imoveis\interna.tpl" */ ?>
<?php /*%%SmartyHeaderCode:313405fd4e74b1b08c1-05502405%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c93539088beebef1c0565d04fc59b2a89ea4f1cc' => 
    array (
      0 => 'core\\templates\\producao\\hubvet\\site\\blocos\\imoveis\\interna.tpl',
      1 => 1607641981,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '313405fd4e74b1b08c1-05502405',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5fd4e74b2b9fd6_51340906',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5fd4e74b2b9fd6_51340906')) {function content_5fd4e74b2b9fd6_51340906($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['imovel'] = new Smarty_variable(monta_imoveis_zeh($_smarty_tpl->tpl_vars['imoveis']->value,$_smarty_tpl->tpl_vars['caracteristicas_tipos']->value), null, 0);?>
...
<?php }?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['imovel']->value->Cidade_txf){?>
            <?php if ($_smarty_tpl->tpl_vars['imovel']->value->Bairro_txf){?> - <?php }?>
            <?php echo $_smarty_tpl->tpl_vars['imovel']->value->Cidade_txf;?>

            <?php }?>

            <?php if ($_smarty_tpl->tpl_vars['imovel']->value->Estado_est){?>
            <?php if ($_smarty_tpl->tpl_vars['imovel']->value->Bairro_txf){?>,&nbsp;<?php }?>
            <?php echo $_smarty_tpl->tpl_vars['imovel']->value->Estado_est;?>

            <?php }?>

            <?php if ($_smarty_tpl->tpl_vars['imovel']->value->Cep_txf){?>
            <?php if ($_smarty_tpl->tpl_vars['imovel']->value->Estado_est){?>, <?php }?>
...
?>
              <div class="col-6 text-center text-lg-left col-lg-auto mb-15 pr-40" title="<?php echo strip_tags($_smarty_tpl->tpl_vars['caracteristica']->value->Nome_tit);?>
">
