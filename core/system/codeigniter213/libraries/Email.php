...
class CI_Email {
	...
	var	$smtp_host		= "ssl://mail.landsmail.srv.br";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "sender@lands.srv.br";		// SMTP Username
	var	$smtp_pass		= "Ld230551";		// SMTP Password
