...
(function($) {
      ...
      $.fn.fileUploader = function(config){
            ...
            config = $.extend({}, {
                  ...
                  selectFileLabel: 'Selecionar arquivo(s)',
		...
		*/
            function beforeEachUpload($form) {
                  ...
                  $uploadData = $form.parent();
                  $uploadData.find('.status').text('Enviando...');
                  $uploadData.removeClass('pending').addClass('uploading');
//                  $uploadData.addClass('resposta_sim');
...
//			alert(status);
                  if (status == 'success'){
//                        $uploadData.find('.resposta_sim').text('Urrull...');
		...
		*/
            function toogleCancel(cancel) {
                  ...
                  if (cancel) {
                        ...
                        //Cancel Button
                        $(config.buttonClear, pxButton).attr({
                              id: 'px-cancel', 
                              title: 'Cancel'
                        });
                  } else {
                        //Clear button
                        $('#px-cancel', pxButton).attr({
                              id: buttonClearId, 
                              title: 'Clear'
                        });
                  }
